...
app.post('/api/scores', async (req, res) => {
    try {
        ...
        // Score submission error - return 500
...
app.post('/api/players/:playerId/upgrade', async (req, res) => {
    try {
        ...
        // Wallet upgrade error - return 500
        res.status(500).json({ error: 'Internal server error' });
    }
});
...
// ============ START SERVER ============
app.listen(PORT, () => {
    // Leaderboard server running on specified port
});
